...
declare module 'fastify' {
    ...
    interface FastifyInstance<RawServer, RawRequest, RawReply> {
        next<RouteGeneric extends RouteGenericInterface = RouteGenericInterface,
            ContextConfig = ContextConfigDefault,
            SchemaCompiler extends FastifySchema = FastifySchema>(
            path: string,
            opts?:
                | (RouteShorthandOptions<RawServer,
                RawRequest,
                RawReply,
                RouteGeneric,
                ContextConfig,
...
declare namespace fastifyNext {
    interface FastifyNextOptions extends NextServerConstructor {
        ...
        /**
         * Expose port for middleware
         * default: 3000
         */
        port?: number,
        /**
         * Expose host for middleware
         * default: 0.0.0.0
         */
        hostname?: string
    }
